...
%%%% Packages
%% ==================================================================
\usepackage[top=3.5cm,left=2cm,right=2cm,bottom=2.5cm,headsep=0.3in,headheight=1in]{geometry}
...
\usepackage[backend=bibtex,citestyle=verbose, bibstyle=verbose]{biblatex}
\usepackage{fancyhdr}
...
\fancyhead[C]{\textbf{HTBLuVA Rankweil}
  \\[0.05in]
