...
\begin{figure}[H]
  \centering
  \frame{\includegraphics[width=1\linewidth]{webinterface/parking_lot_er.pdf}}
...
\begin{listing}[H]
  ...
  \end{minted}
  \caption{Beispielhafte Parklücken POST API Rückgabe}
\end{listing}
