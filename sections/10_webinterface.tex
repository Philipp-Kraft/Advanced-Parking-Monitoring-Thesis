...
sind. Ein weiter Vorteil ist die Übersichtlichkeit und die Wartung, auf dem
...
WSL2 virtualisiert hierbei mithilfe von Hyper-V einen vollständigen
Linux-Kernel, ein Nachteil davon ist, dass durch den Einsatz von Hyper-V auch
das Host-Betriebssystem virtualisiert ist, jedoch ist das wenig bis gar nicht
...
es sinnvoll ein Bash alias zu setzen:
...
starten, dabei wird MySQL, Apache, Redis und PHP gestartet. Es muss nichts
konfiguriert werden, ist es doch gewünscht an der Docker Virtualisierung etwas
anzupassen kann dies über die Datei \verb|docker-compose.yml| im Rootverzeichnis
der Laravel Anwendung vorgenommen werden.
...
Verbindungmit Laravel gewählt. PHP und Larvel in Kombination wurden aus
...
\begin{itemize}
  ...
  Cross-Site-Scripting und SQL Injection kein Problem mehr.
...
\begin{itemize}
  ...
  Öffentliche Routen können von jedem Benutzer erreicht werden.
...
sind die alle Routen der Benutzerverwaltung dargelegt.
