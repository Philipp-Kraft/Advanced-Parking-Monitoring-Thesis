...
Dies ist dadurch möglich, dass das Netzwerk auf einer variablen Schichtanzahl, in dieser Applikation sind es insgesamt 160, aufgebaut ist. In dieser Applikation wird es deswegen verwendet, da damit in diesem Bereich eine hohe Präzision erzielbar ist, 
...
nahezu 100\% gesteigert werden, aber dazu benötigt es einen stärkeren Computer, welcher zudem während dieses Vorganges so gut wie nicht benutzbar ist, da die Hardware komplett ausgelastet ist.
