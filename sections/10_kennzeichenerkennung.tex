...
\subsubsection{Verwendete Librarys}

\paragraph{Versionsübersicht der verwendeten Librarys}\mbox{}\\
Im Folgenden werden die verwendeten Versionen der benötigten Librarys aufgelistet, um das Programm zu starten. Dies wird noch einmal 
...
Unter Windows ist die Installation vergleichbar mit anderen Librarys, es muss einfach der folgende Befehl in der Konsole eingegeben werden:
...
Die Installation von Tensorflow unter Windows ist einfach, da man es wie andere Librarys einfach über pip installieren kann.
...
Im nächsten Schritt müssen noch zusätzlich erforderliche Librarys installiert werden:
